...
{ 
public:
	SDK_UNDEFINED(80,346) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,347) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
public:
	...
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key);                                               // [0xe1ba00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0xe1b840] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0xe1b7b0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0xe1bb10] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(80,348) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,349) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0228   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,350) /* TSet<FName> */            __um(Tags);                                                 // 0x0098   (0x0050)  
