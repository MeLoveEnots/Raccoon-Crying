...
public:
	...
	SDK_UNDEFINED(16,284) /* FMulticastInlineDelegate */ __um(OnActorFracture);                                    // 0x0228   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,285) /* FMulticastInlineDelegate */ __um(OnComponentFracture);                                // 0x06D0   (0x0010)  
	...
	// void SetDestructibleMesh(class UDestructibleMesh* NewMesh);                                                              // [0x881f60] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.GetDestructibleMesh
	// class UDestructibleMesh* GetDestructibleMesh();                                                                          // [0x881f30] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyRadiusDamage
	// void ApplyRadiusDamage(float BaseDamage, FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage); // [0x881d70] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyDamage
	// void ApplyDamage(float DamageAmount, FVector& HitLocation, FVector& ImpulseDir, float ImpulseStrength);                  // [0x881bf0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
