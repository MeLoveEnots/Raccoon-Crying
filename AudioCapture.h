...
public:
	...
	// void StopCapturingAudio();                                                                                               // [0x105cee0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.StartCapturingAudio
	// void StartCapturingAudio();                                                                                              // [0x105cec0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.IsCapturingAudio
	// bool IsCapturingAudio();                                                                                                 // [0x105ce90] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.GetAudioCaptureDeviceInfo
	// bool GetAudioCaptureDeviceInfo(FAudioCaptureDeviceInfo& OutInfo);                                                        // [0x105cde0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UAudioCapture* CreateAudioCapture();                                                                               // [0x105cdb0] Final|Native|Static|Public|BlueprintCallable 
};
