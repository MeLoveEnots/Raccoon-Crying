...
{ 
	SDK_UNDEFINED(80,615) /* TSet<FString> */          __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,616) /* TSet<int32_t> */          __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,617) /* TSet<FName> */            __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,618) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                          // 0x00F0   (0x0050)  
};
