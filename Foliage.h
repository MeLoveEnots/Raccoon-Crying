...
{ 
public:
	SDK_UNDEFINED(16,369) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0678   (0x0010)  
	SDK_UNDEFINED(16,370) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0688   (0x0010)  
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x23d1fc0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x23d1e80] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x23d1c70] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                         // [0x23d2120] Final|Native|Public|BlueprintCallable 
};
