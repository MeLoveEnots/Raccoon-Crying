...
{ 
public:
	SDK_UNDEFINED(80,328) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActorSet);                                // 0x0038   (0x0050)  
	...
	SDK_UNDEFINED(80,329) /* TSet<UPhysicalMaterial*> */ __um(ChaosBreakingMaterialSet);                           // 0x0138   (0x0050)  
