...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0xb57d40] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* MeshComp);                                              // [0xb57ca0] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* MeshComp);                                                                 // [0xb57c00] Final|Native|Public|BlueprintCallable|Const 
};
