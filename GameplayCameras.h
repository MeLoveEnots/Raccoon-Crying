...
public:
	...
	// class UMatineeCameraShake* StartMatineeCameraShakeFromSource(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, class UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot); // [0xdeb690] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayCameras.MatineeCameraShake.StartMatineeCameraShake
	// class UMatineeCameraShake* StartMatineeCameraShake(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot); // [0xdeb4c0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayCameras.MatineeCameraShake.ReceiveStopShake
	// void ReceiveStopShake(bool bImmediately);                                                                                // [0x1414700] Event|Public|BlueprintEvent 
	// Function /Script/GameplayCameras.MatineeCameraShake.ReceivePlayShake
	// void ReceivePlayShake(float Scale);                                                                                      // [0x1414700] Event|Public|BlueprintEvent 
	// Function /Script/GameplayCameras.MatineeCameraShake.ReceiveIsFinished
	// bool ReceiveIsFinished();                                                                                                // [0xdeb490] Native|Event|Public|BlueprintEvent|Const 
	// Function /Script/GameplayCameras.MatineeCameraShake.BlueprintUpdateCameraShake
	// void BlueprintUpdateCameraShake(float DeltaTime, float Alpha, FMinimalViewInfo& POV, FMinimalViewInfo& ModifiedPOV);     // [0x1414700] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// class UMatineeCameraShake* Conv_MatineeCameraShake(class UCameraShakeBase* CameraShake);                                 // [0xdeb410] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
